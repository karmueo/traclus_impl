...
def train_traclus(point_iterable_list, epsilon, min_neighbors, \
    ...
    return train_get_clusters(point_iterable_list=cleaned_input, \
                               epsilon=epsilon, \
...
def train_get_clusters(point_iterable_list, epsilon, min_neighbors, \
    ...
    all_traj_segs_iter_from_all_points_caller = get_all_trajectory_line_segments_iterable_from_all_points_iterable_caller(
            get_line_segs_from_points_func=get_trajectory_line_segments_from_points_iterable2, \
...
def get_trajectory_line_segments_from_points_iterable2(point_iterable, trajectory_line_segment_factory, trajectory_id, \
